import { RestHandler, Action } from "volvo-web-components/volvo-vehicle/volvo-vehicle";
...
export class SamyCitiesdataHandler extends RestHandler {
    constructor() {
        ...
        this.registerEndpoint(Weather, Action.Get, {
            uri: (city) => `https://api.openweathermap.org/data/2.5/weather?id=${city.id}&appid=${key}`,
            method: "GET"
        }, (result) => {
...
//# sourceMappingURL=samy-citiesdata-handler.js.map