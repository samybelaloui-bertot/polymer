...
import { Action } from "volvo-web-components/volvo-vehicle/volvo-vehicle";
...
export class SamyWeather extends PolymerElement {
    ...
    connectedCallback() {
        ...
        const autocomplete = this.$.cityAutocomplete;
    ...
    async _getWeatherOfCity() {
        ...
        if (this.cityHandler && this.cityHandler.can(Weather, Action.Get)) {
            this.cityHandler
                .perform(Weather, Action.Get, { id: cityId })
                .then(weather => {
                console.log(weather);
